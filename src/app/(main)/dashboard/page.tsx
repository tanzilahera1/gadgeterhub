...
import { 
  ...
  ArrowRight, ShoppingBag, MapPin, Search
} from "lucide-react";
    ...
    <div className="space-y-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 font-medium tracking-tight">Recent activity for {session.user.name}</p>
        </div>
            ...
            <div key={order._id} className="bg-white rounded-[2rem] border border-slate-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
               ...
               <div className="p-6 sm:p-8 border-b border-slate-100">
                  <div className="relative flex items-center justify-between">
                    ...
                    {/* Active Line */}
                    <div 
                      className="absolute left-0 top-[1.125rem] h-1 bg-primary rounded-full transition-all duration-1000 ease-out" 
