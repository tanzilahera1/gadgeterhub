        ...
        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
          ...
          <div className="relative group">
            <div className="relative size-32 rounded-3xl overflow-hidden border-4 border-white shadow-xl bg-slate-50">
              {formData.image ? (
                <Image src={formData.image} alt={formData.fullName} fill className="object-cover" />
              ) : (
          ...
          <div className="flex-1 space-y-1 text-center md:text-left">
            <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight">Profile Photo</h3>
            <p className="text-sm font-medium text-slate-400 max-w-xs">Upload a professional headshot. JPEG or PNG, max 2MB.</p>
          </div>
        </div>
